...
from infer_sail import Predictor
...
def parse_args():
    ...
    parser.add_argument('--bmodel', type=str, default='./model/pp-humansegv2-mobile_192x192_fp32.bmodel', help='path of bmodel')
